...
//                             <Button outline onClick={this.setModalOpen} className="bg-light">
//                                 <span className="fa fa-sign-in fa-lg"></span> Submit comment
//                             </Button>
//                             <CommentForm isModalOpen={this.state.isModalOpen} setModalOpen={this.setModalOpen} dishId={this.props.dish.id} addComment={this.props.addComment}/>
//                         </div>
//                     </div>
//                 </div>
//                 </div>
